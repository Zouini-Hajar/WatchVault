    ...
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
        <Link to='/' className="flex items-center ps-2.5 mb-5">
          ...
          <span className="self-center text-xl font-semibold whitespace-nowrap text-white">WatchVault</span>
        </Link>
        <ul className="space-y-2 font-medium">
          <li>
            <Link to='/' className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
              <span className="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white text-xl">
                <MdSpaceDashboard />
              </span>
